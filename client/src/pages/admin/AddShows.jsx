...
const AddShows = () => {
  ...
  const handleRemoveTime = (date, time) => {
    setDateTimeSelection((prev) => {
      ...
      const filteredTimes = currentTimes.filter((t) => t !== time);
  ...
  return nowPlayingMovies.length > 0 ? (
    <>
      ...
      <h2 className="mt-10 text-xl font-medium">Now Playing Movies</h2>
              ...
              <div className="relative rounded-lg overflow-hidden">
                ...
                <div className="text-sm flex items-center justify-between p-2 bg-black/70 w-full absolute bottom-0 left-0">
                  ...
                  <p className="text-gray-300">
                    {rateConverter(movie.vote_count)} Votes
                  </p>
                </div>
              </div>
      ...
      <div className="mt-8">
        ...
        <div className="inline-flex items-center gap-2 border border-r-gray-600 px-3 py-2 rounded-md">
